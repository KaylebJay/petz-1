...
petz.settings.piggeon_spawn = settings:get_bool("piggeon_spawn", true)
petz.settings.piggeon_spawn_chance = tonumber(settings:get("piggeon_spawn_chance"))
petz.settings.piggeon_follow = settings:get("piggeon_follow", "")
